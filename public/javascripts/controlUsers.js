																...
																'<form method="post" action="/user/device">'+
																	'<div class="row">'+
																		...
																		'<i id="editDevice" onclick="editDevice($(this))"'+
														 				...
														 				'<i id="showStatus" data-toggle="tooltip", data-deviceId="'+data.deviceId+'", data-placement="right" data-original-title="Disconnected"'+
														 				'class="mdi mdi-brightness-1 show-status disconnected"></i>'+
														 				'<label class="device-type">'+data.deviceType+'</label>'+  // << type is here!!!
														 			'</div>'+
														 			'<div class="row">'+
														 				'<div class="col-md-12">'+
														 					'<input type="hidden" name="deviceId" value="'+data.deviceId+'"  data-projectName="'+data.deviceName+'" '+
																			'data-projectDescription="'+data.deviceDescription+'">'+
						...
						$('#allProjects_panel').append('<div id='+data.projectId+' class="col-md-4 col-dashboard">'+
															...
															'<div class="panel-heading panel-head-project">'+
																'<form method="post" action="/user/project">'+
																	'<div class="row">'+
																		'<button id="deleteProjectButton" type="button" aria-hidden="true" onclick="deleteProject($(this))" data-projectid="'+data.projectId+'" '+
																		'class="close close-icon">×</button>'+
																		'<i id="editProject" onclick="editProject($(this))" data-projectId="'+data.projectId+'" data-projectName="'+data.projectName+'" '+
																		'data-projectDescription="'+data.projectDescription+'" '+
																		'class="mdi mdi-settings edit-icon"></i>'+
																	'</div>'+
																	'<div class="row">'+
																		'<div class="col-md-12">'+
																			'<input type="hidden" name="projectId" value="'+data.projectId+'" data-projectName="'+data.projectName+'" '+
																			'data-projectDescription="'+data.projectDescription+'">'+
																			'<button type="submit" class="btn-projectName">'+
